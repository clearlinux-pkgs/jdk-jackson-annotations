...
#
Name     : jdk-jackson-annotations
Version  : 2.7.6
Release  : 1
URL      : https://github.com/FasterXML/jackson-annotations/archive/jackson-annotations-2.7.6.tar.gz
Source0  : https://github.com/FasterXML/jackson-annotations/archive/jackson-annotations-2.7.6.tar.gz
Summary  : No detailed summary available
Group    : Development/Tools
License  : Apache-2.0
Requires: jdk-jackson-annotations-data
...
%package data
Summary: data components for the jdk-jackson-annotations package.
Group: Data

%description data
data components for the jdk-jackson-annotations package.


%prep
%setup -q -n jackson-annotations-jackson-annotations-2.7.6

python3 /usr/share/java-utils/mvn_file.py : jackson-annotations

%build
python3 /usr/share/java-utils/mvn_build.py

%install
xmvn-install  -R .xmvn-reactor -n jackson-annotations -d %{buildroot}
